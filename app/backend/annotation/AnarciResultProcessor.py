...
class AnarciResultProcessor:
    ...
    def _detect_constant_region(self, sequence: str, start_pos: int = 0) -> Optional[Dict[str, Any]]:
        """
        ...
        for biologic_name, chains_dict in input_dict.items():
            ...
            for chain_name, chain_seq in chains_dict.items():
                ...
                for dom_idx, domain_start, domain_end in domain_positions:
                    ...
                    chain_type = domain_alignment.get('chain_type') if isinstance(domain_alignment, dict) else None
                    species = domain_alignment.get('species') if isinstance(domain_alignment, dict) else None
                    ...
                    if domain_end < len(raw_sequence):
                        ...
                        constant_info = self._detect_constant_region(remaining_seq, domain_end)
                        if constant_info:
